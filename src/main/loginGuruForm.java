...
public class loginGuruForm extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            query = "SELECT * FROM tbguru WHERE nip = '" + usn + "' AND password = '" + password + "'";
            rs = stm.executeQuery(query);

            while(rs.next()){
                cekuser = rs.getString("nip");
        ...
        if(cekuser == null && cekpassword == null){
            String gagal = "NIP Atau Password Salah";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginGuruForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
