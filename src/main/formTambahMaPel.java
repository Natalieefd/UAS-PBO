...
public class formTambahMaPel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("AlokasiWaktu / Minggu");
    ...
    private void btnSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubmitMouseClicked
        try {
            query = "INSERT INTO tbmatapelajaran(idmatapelajaran, nama, alokasiwaktu) VALUES('"+ txtID.getText() +"', '"+ txtNama.getText() +"', '"+ txtWaktu.getText() +"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formTambahMaPel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
