...
public class loginStafForm extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            query = "SELECT * FROM tbstaf WHERE nip = '" + usn + "' AND password = '" + password + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginStafForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
