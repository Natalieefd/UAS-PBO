...
public class akunGuru extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("DAFTAR AKUN GURU");
        jLabel6.setIconTextGap(15);

        tbGuru.setBackground(new java.awt.Color(204, 204, 204));
        ...
        tbGuru.setPreferredSize(new java.awt.Dimension(450, 40));
        ...
        lblLogout4.setFont(new java.awt.Font("TT Commons DemiBold", 1, 14)); // NOI18N
        lblLogout4.setForeground(new java.awt.Color(255, 255, 255));
        lblLogout4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblLogout4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/logout-dark-24px.png"))); // NOI18N
        lblLogout4.setText("LOGOUT");
        lblLogout4.setIconTextGap(7);
        ...
        lblBack3.setFont(new java.awt.Font("Vela Sans SemBd", 0, 12)); // NOI18N
        lblBack3.setForeground(new java.awt.Color(38, 46, 61));
        lblBack3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/chevron-dark.png"))); // NOI18N
        lblBack3.setText("Back");
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelBorder1Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(lblBack3, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public void tampilData(){
        ...
        DftTblModel_Guru.addColumn("NIP");
        DftTblModel_Guru.addColumn("Nama");
        DftTblModel_Guru.addColumn("Password");
        DftTblModel_Guru.addColumn("Tempat Lahir");
        DftTblModel_Guru.addColumn("Tanggal Lahir");
        DftTblModel_Guru.addColumn("Jenis Kelamin");
        
        tbGuru.setModel(DftTblModel_Guru);
        try {
            DftTblModel_Guru.fireTableDataChanged();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(akunGuru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
