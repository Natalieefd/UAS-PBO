...
public class formTambahJadwalKBM extends javax.swing.JFrame {
    ...
    private void btnSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubmitMouseClicked
        try {
            query = "INSERT INTO tbjadwalkbm(kelas, hari, jam, matapelajaran, keterangan) VALUES('"+ txtKelas.getText() +"', '"+ txtHari.getText() +"', '"+ txtJam.getText() +"', '"+ txtMaPel.getText() +"', '"+ txtKeterangan.getText() +"')";
            prep = conn.prepareStatement(query);
            prep.execute();

            String berhasil = "Tambah data Berhasil";
            ...
            dispose();
                ...
                String gagal = "Tambah data Gagal";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formTambahJadwalKBM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
